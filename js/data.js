...
const APK_MENU = {
  ...
  { id:"tacos-1viande", category:"tacos", name:"Tacos 1 Viande", description:"Frite +1€ · Boisson +1€", price:8.00, image:"img/tacos.jpg", badge:null, options:[{ label:"Viande", type:"radio", required:true, choices:["Steak Haché","Poulet","Tenders","Merguez","Chorizo","Nugett","Cordon Bleu","Kebab","Omelette","Poulet Tandoori","Poulet Curry"] }, { label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Frite", price:1.00 },{ name:"Boisson", price:1.00 },{ name:"Viande supplémentaire", price:2.00 }] }] },
  ...
  { id:"sw-kebab", category:"sandwichs", name:"Kebab", description:"Pain, viande kebab, salade, tomate, oignon — Maxi +2€ · Pain ou Durum", price:7.00, image:"img/sandwich.jpg", badge:null, options:[{ label:"Format", type:"radio", required:true, choices:["Normal","Maxi (+2,00€)","Durum"] }, { label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }] },
  { id:"sw-americain", category:"sandwichs", name:"Américain", description:"Steak haché (90g), cheddar, salade, tomate, oignon", price:7.00, image:"img/sandwich.jpg", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }] },
  { id:"sw-chicken-tandoori", category:"sandwichs", name:"Chicken Tandoori", description:"Poulet tandoori, cheddar, salade, tomate, oignon", price:8.00, image:"img/sandwich.jpg", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }] },
  { id:"sw-chicken-curry", category:"sandwichs", name:"Chicken Cheese Curry", description:"Poulet curry, cheddar, salade, tomate, oignon", price:8.00, image:"img/sandwich.jpg", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }] },
  { id:"sw-big-americain", category:"sandwichs", name:"Big Américain", description:"2 steaks (90g), 2 cheddars, oeuf, salade, tomate, oignon", price:9.00, image:"img/sandwich.jpg", badge:"Maxi", options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }] },
  ...
  { id:"burger-hamburger", category:"burgers", name:"Hamburger", description:"Steak 90g, 1 oeuf, 2 cheddar, salade, tomate, oignon", price:7.00, image:"https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=85", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 },{ name:"Raclette", price:1.60 },{ name:"Reblochon", price:1.60 },{ name:"Cheddar", price:1.60 },{ name:"Chèvre", price:1.60 },{ name:"Miel", price:1.60 },{ name:"Oeuf", price:1.60 },{ name:"Steak 45g", price:1.60 },{ name:"Steak 90g", price:2.00 }] }] },
  { id:"burger-chicken-crispy", category:"burgers", name:"Chicken Crispy", description:"Crispy, cheddar, chèvre, miel, salade, tomate, oignon", price:10.00, image:"https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=85", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 },{ name:"Raclette", price:1.60 },{ name:"Reblochon", price:1.60 },{ name:"Cheddar", price:1.60 },{ name:"Chèvre", price:1.60 },{ name:"Miel", price:1.60 },{ name:"Oeuf", price:1.60 },{ name:"Steak 45g", price:1.60 },{ name:"Steak 90g", price:2.00 }] }] },
  { id:"burger-chicken-burger", category:"burgers", name:"Chicken Burger", description:"2 tenders, 2 cheddar, salade, tomate, oignon", price:7.00, image:"https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=85", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 },{ name:"Raclette", price:1.60 },{ name:"Reblochon", price:1.60 },{ name:"Cheddar", price:1.60 },{ name:"Chèvre", price:1.60 },{ name:"Miel", price:1.60 },{ name:"Oeuf", price:1.60 },{ name:"Steak 45g", price:1.60 },{ name:"Steak 90g", price:2.00 }] }] },
  { id:"burger-big", category:"burgers", name:"Big Burger", description:"2 steaks 90g, 1 oeuf, 2 cheddar, salade, tomate, oignon", price:10.00, image:"https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=85", badge:"Populaire", options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 },{ name:"Raclette", price:1.60 },{ name:"Reblochon", price:1.60 },{ name:"Cheddar", price:1.60 },{ name:"Chèvre", price:1.60 },{ name:"Miel", price:1.60 },{ name:"Oeuf", price:1.60 },{ name:"Steak 45g", price:1.60 },{ name:"Steak 90g", price:2.00 }] }] },
  { id:"burger-bc", category:"burgers", name:"B&C", description:"1 steak 90g, 1 Crispy, oignon, 2 cheddar, salade, tomate", price:10.00, image:"https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=85", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 },{ name:"Raclette", price:1.60 },{ name:"Reblochon", price:1.60 },{ name:"Cheddar", price:1.60 },{ name:"Chèvre", price:1.60 },{ name:"Miel", price:1.60 },{ name:"Oeuf", price:1.60 },{ name:"Steak 45g", price:1.60 },{ name:"Steak 90g", price:2.00 }] }] },
  { id:"burger-king", category:"burgers", name:"King Arena Max", description:"3 steaks, 1 omelette, 3 cheddar, raclette", price:13.00, image:"https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=85", badge:"King", options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 },{ name:"Raclette", price:1.60 },{ name:"Reblochon", price:1.60 },{ name:"Cheddar", price:1.60 },{ name:"Chèvre", price:1.60 },{ name:"Miel", price:1.60 },{ name:"Oeuf", price:1.60 },{ name:"Steak 45g", price:1.60 },{ name:"Steak 90g", price:2.00 }] }] },
  ...
  { id:"tarte-daim", category:"desserts", name:"Tarte au Daim", description:"Tarte croustillante au caramel Daim", price:3.50, image:"https://images.unsplash.com/photo-1571115177098-24ec42ed204d?w=600&q=85", badge:null, options:[] },
  { id:"hagen-100", category:"desserts", name:"Häagen-Dazs 100ml", description:"Mini pot glace premium individuel", price:4.50, image:"https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=600&q=85", badge:null, options:[{ label:"Parfum", type:"radio", required:true, choices:["Vanille","Fraise","Chocolat","Caramel","Cookie"] }] },
  { id:"hagen-500", category:"desserts", name:"Häagen-Dazs 500ml", description:"Grand pot glace premium — à partager", price:9.00, image:"https://images.unsplash.com/photo-1497034825429-c343d7c6a68f?w=600&q=85", badge:"Famille", options:[{ label:"Parfum", type:"radio", required:true, choices:["Vanille","Fraise","Chocolat","Caramel","Cookie"] }] },
