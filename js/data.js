...
const APK_MENU = {
  ...
  { id:"tacos-1viande", category:"tacos", name:"Tacos 1 Viande", description:"Frite +1€ · Boisson +1€", price:8.00, image:"https://frenchtacoslondon.com/_astro/special@1200w.46c03b23.jpeg", badge:null, options:[{ label:"Viande", type:"radio", required:true, choices:["Steak Haché","Poulet","Tenders","Merguez","Chorizo","Nugett","Cordon Bleu","Kebab","Omelette","Poulet Tandoori","Poulet Curry"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Frite", price:1.00 },{ name:"Boisson", price:1.00 },{ name:"Viande supplémentaire", price:2.00 }] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
  ...
  { id:"defsoce", category:"tacos", name:"Defsoce", description:"Viande hachée / Poulet / Kebab / Merguez + Boisson", price:12.00, image:"https://frenchtacoslondon.com/_astro/special@1200w.46c03b23.jpeg", badge:null, options:[{ label:"Viande", type:"radio", required:true, choices:["Viande Hachée","Poulet","Kebab","Merguez"] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
  { id:"roll-bourssin", category:"rolls", name:"Roll Bourssin", description:"Galette, Tenders, Bourssin, Oeuf — avec frite + boisson", price:13.00, image:"https://www.hftheking.fr/images/Wrap_Tenders.png", badge:null, options:[{ label:"Supplément fromage (+1€)", type:"multi", required:false, choices:[{ name:"Raclette", price:1.00 },{ name:"Reblochon", price:1.00 },{ name:"Chèvre", price:1.00 },{ name:"Cheddar", price:1.00 }] }] },
  { id:"roll-queen", category:"rolls", name:"Queen Arena", description:"Galette, Steak, Cheddar, Oeuf — avec frite + boisson", price:13.00, image:"https://www.hftheking.fr/images/Wrap_Tenders.png", badge:"Signature", options:[{ label:"Supplément fromage (+1€)", type:"multi", required:false, choices:[{ name:"Raclette", price:1.00 },{ name:"Reblochon", price:1.00 },{ name:"Chèvre", price:1.00 },{ name:"Cheddar", price:1.00 }] }] },
  ...
  { id:"panini-menu", category:"panini", name:"Panini Menu", description:"Au choix : Poulet, Kebab, 4 Fromage, Jambon, Viande Hachée", price:8.00, image:"https://images.unsplash.com/photo-1550507992-eb63ffee0847?w=600&q=85", badge:null, options:[{ label:"Garniture", type:"radio", required:true, choices:["Poulet","Kebab","4 Fromage","Jambon","Viande Hachée"] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
  { id:"fc-tenders5", category:"fried-chicken", name:"Menu 1 Pers. — Tenders x5", description:"5 Tenders + frites + boisson 33cl", price:9.90, image:"https://www.tasteofhome.com/wp-content/uploads/2018/01/Crispy-Fried-Chicken_EXPS_TOHJJ22_6445_DR-_02_03_11b.jpg", badge:null, options:[{ label:"Sauce", type:"radio", required:true, choices:["Barbecue","Biggy","Blanche","Mayo","Ketchup","Andalouse","Samouraï","Harissa","Brézil","Chili Thaï","Algérienne"] }] },
  ...
  { id:"fc-tenders10", category:"fried-chicken", name:"Menu 2 Pers. — Tenders x10", description:"10 Tenders + 2 frites + 2 boissons", price:19.00, image:"https://www.tasteofhome.com/wp-content/uploads/2018/01/Crispy-Fried-Chicken_EXPS_TOHJJ22_6445_DR-_02_03_11b.jpg", badge:"Duo", options:[{ label:"Sauce", type:"radio", required:true, choices:["Barbecue","Biggy","Blanche","Mayo","Ketchup","Andalouse","Samouraï","Harissa","Brézil","Chili Thaï","Algérienne"] }] },
  ...
  { id:"fc-mix", category:"fried-chicken", name:"Menu 2 Pers. — Mix x7+x7", description:"7 Tenders + 7 Wings + 2 frites + 2 boissons", price:19.00, image:"https://www.tasteofhome.com/wp-content/uploads/2018/01/Crispy-Fried-Chicken_EXPS_TOHJJ22_6445_DR-_02_03_11b.jpg", badge:"Duo", options:[{ label:"Sauce", type:"radio", required:true, choices:["Barbecue","Biggy","Blanche","Mayo","Ketchup","Andalouse","Samouraï","Harissa","Brézil","Chili Thaï","Algérienne"] }] },
  { id:"sw-kebab", category:"sandwichs", name:"Kebab", description:"Pain, viande kebab, salade, tomate, oignon — Maxi +2€ · Pain ou Durum", price:7.00, image:"https://www.mashed.com/img/gallery/new-york-chopped-cheese-sandwich-recipe/l-intro-1683056781.jpg", badge:null, options:[{ label:"Format", type:"radio", required:true, choices:["Normal","Maxi (+2,00€)","Durum"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
  { id:"sw-americain", category:"sandwichs", name:"Américain", description:"Steak haché (90g), cheddar, salade, tomate, oignon", price:7.00, image:"https://www.mashed.com/img/gallery/new-york-chopped-cheese-sandwich-recipe/l-intro-1683056781.jpg", badge:null, options:[{ label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
  { id:"sw-chicken-tandoori", category:"sandwichs", name:"Chicken Tandoori", description:"Poulet tandoori, cheddar, salade, tomate, oignon", price:8.00, image:"https://www.mashed.com/img/gallery/new-york-chopped-cheese-sandwich-recipe/l-intro-1683056781.jpg", badge:null, options:[{ label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
  { id:"sw-chicken-curry", category:"sandwichs", name:"Chicken Cheese Curry", description:"Poulet curry, cheddar, salade, tomate, oignon", price:8.00, image:"https://www.mashed.com/img/gallery/new-york-chopped-cheese-sandwich-recipe/l-intro-1683056781.jpg", badge:null, options:[{ label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
  { id:"sw-big-americain", category:"sandwichs", name:"Big Américain", description:"2 steaks (90g), 2 cheddars, oeuf, salade, tomate, oignon", price:9.00, image:"https://www.mashed.com/img/gallery/new-york-chopped-cheese-sandwich-recipe/l-intro-1683056781.jpg", badge:"Maxi", options:[{ label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
  { id:"assiette-kebab", category:"assiettes", name:"Assiette Kebab", description:"2 viandes au choix + frites", price:11.00, image:"https://kebabaproximite.fr/wp-content/uploads/assiette-kebab-maison.gif", badge:null, options:[{ label:"Viande 1", type:"radio", required:true, choices:["Steak Haché","Poulet","Kebab","Merguez","Chorizo","Poulet Tandoori"] }, { label:"Viande 2", type:"radio", required:true, choices:["Steak Haché","Poulet","Kebab","Merguez","Chorizo","Poulet Tandoori"] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
  { id:"assiette-mixte", category:"assiettes", name:"Assiette Mixte", description:"2 viandes au choix + frites", price:14.00, image:"https://kebabaproximite.fr/wp-content/uploads/assiette-kebab-maison.gif", badge:null, options:[{ label:"Viande 1", type:"radio", required:true, choices:["Steak Haché","Poulet","Kebab","Merguez","Chorizo","Poulet Tandoori"] }, { label:"Viande 2", type:"radio", required:true, choices:["Steak Haché","Poulet","Kebab","Merguez","Chorizo","Poulet Tandoori"] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
