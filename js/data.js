...
const APK_MENU = {
  ...
  items: [
    ...
    { id:"cannette", category:"boissons", name:"Cannette 33cl", description:"Coca-Cola, Fanta, Sprite au choix", price:2.00, image:"https://thumbs.dreamstime.com/b/canettes-de-boissons-gazeuses-populaires-poznan-pol-mai-y-compris-le-coca-cola-fanta-dr-pepper-sprite-lipton-ice-tea-et-schweppes-220229107.jpg", badge:null, options:[{ label: "Choix", type: "select", required: true, choices: ["Coca-Cola","Coca-Cola Zero","Fanta Orange","Sprite"] }] },
