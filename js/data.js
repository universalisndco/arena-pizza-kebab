...
const APK_MENU = {
  ...
  { id:"tacos-1viande", category:"tacos", name:"Tacos 1 Viande", description:"Frite +1€ · Boisson +1€", price:8.00, image:"img/tacos.jpg", badge:null, options:[{ label:"Viande", type:"radio", required:true, choices:["Steak Haché","Poulet","Tenders","Merguez","Chorizo","Nugett","Cordon Bleu","Kebab","Omelette","Poulet Tandoori","Poulet Curry"] }, { label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 },{ name:"Viande supplémentaire", price:2.00 }] }] },
  ...
  { id:"defsoce", category:"tacos", name:"Defsoce", description:"Viande hachée / Poulet / Kebab / Merguez + Boisson", price:12.00, image:"img/tacos.jpg", badge:null, options:[{ label:"Viande", type:"radio", required:true, choices:["Viande Hachée","Poulet","Kebab","Merguez"] }, { label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }] },
  { id:"roll-bourssin", category:"rolls", name:"Roll Bourssin", description:"Galette, Tenders, Bourssin, Oeuf — avec frite + boisson", price:13.00, image:"img/roll.jpg", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Supplément fromage (+1€)", type:"multi", required:false, choices:[{ name:"Raclette", price:1.00 },{ name:"Reblochon", price:1.00 },{ name:"Chèvre", price:1.00 },{ name:"Cheddar", price:1.00 }] }] },
  { id:"roll-queen", category:"rolls", name:"Queen Arena", description:"Galette, Steak, Cheddar, Oeuf — avec frite + boisson", price:13.00, image:"img/roll.jpg", badge:"Signature", options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Supplément fromage (+1€)", type:"multi", required:false, choices:[{ name:"Raclette", price:1.00 },{ name:"Reblochon", price:1.00 },{ name:"Chèvre", price:1.00 },{ name:"Cheddar", price:1.00 }] }] },
  { id:"krousty-apk", category:"krousty", name:"Krousty APK", description:"Riz Blanc, Sauce Blanche Maison, Sauce Thaï Maison, Oignon Frits — avec Boisson", price:10.00, image:"img/krousty.jpg", badge:"Nouveau", options:[{ label:"Boisson incluse", type:"radio", required:true, choices:["Coca-Cola","Coca-Cola Zero","Fanta Orange","Sprite","Oasis Tropical","Lipton Ice Tea","Orangina","Perrier"] }] },
  { id:"krousty-curry", category:"krousty", name:"Riz Chicken Curry", description:"Chicken, Crème de Curry, Riz Blanc, Sauce Blanche, Sauce Thaï, Oignon Frits — avec Boisson", price:12.00, image:"img/krousty.jpg", badge:"Nouveau", options:[{ label:"Boisson incluse", type:"radio", required:true, choices:["Coca-Cola","Coca-Cola Zero","Fanta Orange","Sprite","Oasis Tropical","Lipton Ice Tea","Orangina","Perrier"] }] },
  { id:"krousty-tandoori", category:"krousty", name:"Riz Chicken Tandoori", description:"Chicken Marinade Tandoori, Riz Blanc, Sauce Blanche, Sauce Thaï, Oignon Frits — avec Boisson", price:12.00, image:"img/krousty.jpg", badge:"Nouveau", options:[{ label:"Boisson incluse", type:"radio", required:true, choices:["Coca-Cola","Coca-Cola Zero","Fanta Orange","Sprite","Oasis Tropical","Lipton Ice Tea","Orangina","Perrier"] }] },
  { id:"panini-menu", category:"panini", name:"Panini Menu", description:"Au choix : Poulet, Kebab, 4 Fromage, Jambon, Viande Hachée", price:8.00, image:"https://images.unsplash.com/photo-1550507992-eb63ffee0847?w=600&q=85", badge:null, options:[{ label:"Garniture", type:"radio", required:true, choices:["Poulet","Kebab","4 Fromage","Jambon","Viande Hachée"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }] },
  { id:"fc-tenders5", category:"fried-chicken", name:"Menu 1 Pers. — Tenders x5", description:"5 Tenders + frites + boisson 33cl", price:9.90, image:"img/fried-chicken.jpg", badge:null, options:[{ label:"Sauce", type:"radio", required:true, choices:["Barbecue","Biggy","Blanche","Mayo","Ketchup","Andalouse","Samouraï","Harissa","Brézil","Chili Thaï","Algérienne"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }] },
  { id:"fc-wings8", category:"fried-chicken", name:"Menu 1 Pers. — Wings x8", description:"8 Wings + frites + boisson 33cl", price:9.90, image:"img/fried-chicken.jpg", badge:null, options:[{ label:"Sauce", type:"radio", required:true, choices:["Barbecue","Biggy","Blanche","Mayo","Ketchup","Andalouse","Samouraï","Harissa","Brézil","Chili Thaï","Algérienne"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }] },
  { id:"fc-tenders10", category:"fried-chicken", name:"Menu 2 Pers. — Tenders x10", description:"10 Tenders + 2 frites + 2 boissons", price:19.00, image:"img/fried-chicken.jpg", badge:"Duo", options:[{ label:"Sauce", type:"radio", required:true, choices:["Barbecue","Biggy","Blanche","Mayo","Ketchup","Andalouse","Samouraï","Harissa","Brézil","Chili Thaï","Algérienne"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }] },
  { id:"fc-wings16", category:"fried-chicken", name:"Menu 2 Pers. — Wings x16", description:"16 Wings + 2 frites + 2 boissons", price:19.00, image:"img/fried-chicken.jpg", badge:"Duo", options:[{ label:"Sauce", type:"radio", required:true, choices:["Barbecue","Biggy","Blanche","Mayo","Ketchup","Andalouse","Samouraï","Harissa","Brézil","Chili Thaï","Algérienne"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }] },
  ...
  { id:"sw-kebab", category:"sandwichs", name:"Kebab", description:"Pain, viande kebab, salade, tomate, oignon — Maxi +2€ · Pain ou Durum", price:7.00, image:"img/sandwich.jpg", badge:null, options:[{ label:"Format", type:"radio", required:true, choices:["Normal","Maxi (+2,00€)","Durum"] }, { label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }] },
  { id:"sw-americain", category:"sandwichs", name:"Américain", description:"Steak haché (90g), cheddar, salade, tomate, oignon", price:7.00, image:"img/sandwich.jpg", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }] },
  { id:"sw-chicken-tandoori", category:"sandwichs", name:"Chicken Tandoori", description:"Poulet tandoori, cheddar, salade, tomate, oignon", price:8.00, image:"img/sandwich.jpg", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }] },
  { id:"sw-chicken-curry", category:"sandwichs", name:"Chicken Cheese Curry", description:"Poulet curry, cheddar, salade, tomate, oignon", price:8.00, image:"img/sandwich.jpg", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }] },
  { id:"sw-big-americain", category:"sandwichs", name:"Big Américain", description:"2 steaks (90g), 2 cheddars, oeuf, salade, tomate, oignon", price:9.00, image:"img/sandwich.jpg", badge:"Maxi", options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }] },
  { id:"assiette-kebab", category:"assiettes", name:"Assiette Kebab", description:"2 viandes au choix + frites", price:11.00, image:"img/assiette.jpg", badge:null, options:[{ label:"Viande 1", type:"radio", required:true, choices:["Steak Haché","Poulet","Kebab","Merguez","Chorizo","Poulet Tandoori"] }, { label:"Viande 2", type:"radio", required:true, choices:["Steak Haché","Poulet","Kebab","Merguez","Chorizo","Poulet Tandoori"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }] },
  { id:"assiette-mixte", category:"assiettes", name:"Assiette Mixte", description:"2 viandes au choix + frites", price:14.00, image:"img/assiette.jpg", badge:null, options:[{ label:"Viande 1", type:"radio", required:true, choices:["Steak Haché","Poulet","Kebab","Merguez","Chorizo","Poulet Tandoori"] }, { label:"Viande 2", type:"radio", required:true, choices:["Steak Haché","Poulet","Kebab","Merguez","Chorizo","Poulet Tandoori"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }] },
  { id:"salade-cesar", category:"salade", name:"Salade César", description:"Salade, Tomate, Olive, Omelette — viande au choix", price:9.00, image:"https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=600&q=85", badge:null, options:[{ label:"Viande", type:"radio", required:true, choices:["Steak Haché","Poulet","Kebab","Tenders","Merguez"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }] },
  { id:"burger-hamburger", category:"burgers", name:"Hamburger", description:"Steak 90g, 1 oeuf, 2 cheddar, salade, tomate, oignon", price:7.00, image:"https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=85", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }, { label:"Suppléments burger", type:"multi", required:false, choices:[{ name:"Raclette", price:1.60 },{ name:"Reblochon", price:1.60 },{ name:"Cheddar", price:1.60 },{ name:"Chèvre", price:1.60 },{ name:"Miel", price:1.60 },{ name:"Oeuf", price:1.60 },{ name:"Steak 45g", price:1.60 },{ name:"Steak 90g", price:2.00 }] }] },
  { id:"burger-chicken-crispy", category:"burgers", name:"Chicken Crispy", description:"Crispy, cheddar, chèvre, miel, salade, tomate, oignon", price:10.00, image:"https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=85", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }, { label:"Suppléments burger", type:"multi", required:false, choices:[{ name:"Raclette", price:1.60 },{ name:"Reblochon", price:1.60 },{ name:"Cheddar", price:1.60 },{ name:"Chèvre", price:1.60 },{ name:"Miel", price:1.60 },{ name:"Oeuf", price:1.60 },{ name:"Steak 45g", price:1.60 },{ name:"Steak 90g", price:2.00 }] }] },
  { id:"burger-chicken-burger", category:"burgers", name:"Chicken Burger", description:"2 tenders, 2 cheddar, salade, tomate, oignon", price:7.00, image:"https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=85", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }, { label:"Suppléments burger", type:"multi", required:false, choices:[{ name:"Raclette", price:1.60 },{ name:"Reblochon", price:1.60 },{ name:"Cheddar", price:1.60 },{ name:"Chèvre", price:1.60 },{ name:"Miel", price:1.60 },{ name:"Oeuf", price:1.60 },{ name:"Steak 45g", price:1.60 },{ name:"Steak 90g", price:2.00 }] }] },
  { id:"burger-big", category:"burgers", name:"Big Burger", description:"2 steaks 90g, 1 oeuf, 2 cheddar, salade, tomate, oignon", price:10.00, image:"https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=85", badge:"Populaire", options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }, { label:"Suppléments burger", type:"multi", required:false, choices:[{ name:"Raclette", price:1.60 },{ name:"Reblochon", price:1.60 },{ name:"Cheddar", price:1.60 },{ name:"Chèvre", price:1.60 },{ name:"Miel", price:1.60 },{ name:"Oeuf", price:1.60 },{ name:"Steak 45g", price:1.60 },{ name:"Steak 90g", price:2.00 }] }] },
  { id:"burger-bc", category:"burgers", name:"B&C", description:"1 steak 90g, 1 Crispy, oignon, 2 cheddar, salade, tomate", price:10.00, image:"https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=85", badge:null, options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }, { label:"Suppléments burger", type:"multi", required:false, choices:[{ name:"Raclette", price:1.60 },{ name:"Reblochon", price:1.60 },{ name:"Cheddar", price:1.60 },{ name:"Chèvre", price:1.60 },{ name:"Miel", price:1.60 },{ name:"Oeuf", price:1.60 },{ name:"Steak 45g", price:1.60 },{ name:"Steak 90g", price:2.00 }] }] },
  { id:"burger-king", category:"burgers", name:"King Arena Max", description:"3 steaks, 1 omelette, 3 cheddar, raclette", price:13.00, image:"https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=85", badge:"King", options:[{ label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Accompagnement", type:"option_radio", required:false, choices:[{ name:"Sans accompagnement", price:0 },{ name:"Menu — Frite + Boisson", price:2.00 },{ name:"Boisson seule", price:1.50 },{ name:"Frite seule", price:1.50 }] }, { label:"Suppléments burger", type:"multi", required:false, choices:[{ name:"Raclette", price:1.60 },{ name:"Reblochon", price:1.60 },{ name:"Cheddar", price:1.60 },{ name:"Chèvre", price:1.60 },{ name:"Miel", price:1.60 },{ name:"Oeuf", price:1.60 },{ name:"Steak 45g", price:1.60 },{ name:"Steak 90g", price:2.00 }] }] },
  ...
  { id:"offre-etudiante", category:"pizza-etudiante", serie:null,
    ...
    options:[
      ...
      { label:"Sauce 1", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }, { label:"Sauce 2", type:"radio", required:true, choices:["Blanche","Algérienne","Harissa","Ketchup","Mayonnaise","Barbecue","Samouraï","Andalouse","Brézil","Chili Thaï","Burger"] }
    ]
  },
