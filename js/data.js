...
const APK_MENU = {
  ...
  { id:"defsoce", category:"tacos", name:"Defsoce", description:"Viande hachée / Poulet / Kebab / Merguez + Boisson", price:12.00, image:"https://pinospizza51.fr/wp-content/uploads/2022/10/life.jpg", badge:null, options:[{ label:"Viande", type:"radio", required:true, choices:["Viande Hachée","Poulet","Kebab","Merguez"] }] },
  ...
  { id:"fc-tenders5", category:"fried-chicken", name:"Menu 1 Pers. — Tenders x5", description:"5 Tenders + frites + boisson 33cl", price:9.90, image:"https://images.unsplash.com/photo-1562802378-063ec186a863?w=600&q=85", badge:null, options:[{ label:"Sauce", type:"radio", required:true, choices:["Barbecue","Biggy","Blanche","Mayo","Ketchup","Andalouse","Samouraï","Harissa","Brézil","Chili Thaï","Algérienne"] }] },
  ...
  { id:"sw-kebab", category:"sandwichs", name:"Kebab", description:"Pain, viande kebab, salade, tomate, oignon — Maxi +2€ · Pain ou Durum", price:7.00, image:"https://images.unsplash.com/photo-1544025162-d76538b4ca4b?w=600&q=85", badge:null, options:[{ label:"Format", type:"radio", required:true, choices:["Normal","Maxi (+2,00€)","Durum"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }] },
  ...
  { id:"hagen-100", category:"desserts", name:"Häagen-Dazs 100ml", description:"Glace premium individuelle", price:4.50, image:"https://images.unsplash.com/photo-1567206563114-c179706a56bf?w=400&q=85", badge:null, options:[{ label:"Parfum", type:"radio", required:true, choices:["Vanille","Fraise","Chocolat","Caramel","Cookie"] }] },
  { id:"hagen-500", category:"desserts", name:"Häagen-Dazs 500ml", description:"Glace premium grand format — à partager", price:9.00, image:"https://images.unsplash.com/photo-1497034825429-c343d7c6a68f?w=400&q=85", badge:"Famille", options:[{ label:"Parfum", type:"radio", required:true, choices:["Vanille","Fraise","Chocolat","Caramel","Cookie"] }] },
