...
const APK_MENU = {
  ...
  { id:"sw-kebab", category:"sandwichs", name:"Kebab", description:"Pain, viande kebab, salade, tomate, oignon — Maxi +2€ · Pain ou Durum", price:7.00, image:"https://www.gazettedebout.org/wp-content/uploads/generated_18167915309628157874.png", badge:null, options:[{ label:"Format", type:"radio", required:true, choices:["Normal","Maxi (+2,00€)","Durum"] }, { label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
  { id:"sw-americain", category:"sandwichs", name:"Américain", description:"Steak haché (90g), cheddar, salade, tomate, oignon", price:7.00, image:"https://www.gazettedebout.org/wp-content/uploads/generated_18167915309628157874.png", badge:null, options:[{ label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
  { id:"sw-chicken-tandoori", category:"sandwichs", name:"Chicken Tandoori", description:"Poulet tandoori, cheddar, salade, tomate, oignon", price:8.00, image:"https://www.gazettedebout.org/wp-content/uploads/generated_18167915309628157874.png", badge:null, options:[{ label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
  { id:"sw-chicken-curry", category:"sandwichs", name:"Chicken Cheese Curry", description:"Poulet curry, cheddar, salade, tomate, oignon", price:8.00, image:"https://www.gazettedebout.org/wp-content/uploads/generated_18167915309628157874.png", badge:null, options:[{ label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
  { id:"sw-big-americain", category:"sandwichs", name:"Big Américain", description:"2 steaks (90g), 2 cheddars, oeuf, salade, tomate, oignon", price:9.00, image:"https://www.gazettedebout.org/wp-content/uploads/generated_18167915309628157874.png", badge:"Maxi", options:[{ label:"Suppléments", type:"multi", required:false, choices:[{ name:"Boisson 33cl", price:1.00 },{ name:"Frites", price:1.00 }] }, { label:"Sauces", type:"multi", required:false, choices:[{name:"Algérienne", price:0}, {name:"Biggy", price:0}, {name:"Sauce Burger", price:0}, {name:"Andalouse", price:0}, {name:"Samouraï", price:0}, {name:"Ketchup", price:0}, {name:"Mayonnaise", price:0}, {name:"Harissa", price:0}, {name:"Barbecue", price:0}, {name:"Blanche", price:0}, {name:"Chili Thaï", price:0}, {name:"Brézil", price:0}, {name:"Fromagère", price:0}, {name:"Moutarde", price:0}, {name:"Tzatziki", price:0}] }] },
