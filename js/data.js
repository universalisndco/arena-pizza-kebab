...
const APK_MENU = {
  ...
  items: [
    ...
    { id:"cannette", category:"boissons", name:"Cannette Coca-Cola 33cl", price:2.00, image:"https://www.valgourmand.com/43067-superlarge_default/coca-cola-boite-33cl.jpg", badge:null, options:[{ label: "Choix", type: "select", required: true, choices: ["Coca-Cola","Coca-Cola Zero","Fanta Orange","Sprite"] }] },
    { id:"cannette", category:"boissons", name:"Cannette Sprite 33cl", price:2.00, image:"https://www.valgourmand.com/51382-superlarge_default/sprite-boite-33cl.jpg", badge:null, options:[{ label: "Choix", type: "select", required: true, choices: ["Coca-Cola","Coca-Cola Zero","Fanta Orange","Sprite"] }] },
    { id:"cannette", category:"boissons", name:"Cannette Oisis 33cl", price:2.00, image:"https://prod.isg.bruneau.media/asset/aHR0cHM6Ly9icnVuZWF1LnNpbXBsZXdvcmtzcGFjZS5uZXQvZmlsZS9wdWJBc3NldEJhc2UvS2doNV9jc0FWX1hOR1FmX3gxWDRtV3FzcmtxaTlNZ1liYjJKa0M2aFQ4Wl9Gb1kzMndFLzE3Mjk2MDEwOTkwMDAwL3MvNzczODQ5LmpwZw==/?quality=85", badge:null, options:[{ label: "Choix", type: "select", required: true, choices: ["Coca-Cola","Coca-Cola Zero","Fanta Orange","Sprite"] }] },
    { id:"cannette", category:"boissons", name:"Cannette Ice-Tea 33cl", price:2.00, image:"https://makisan.fr/wp-content/uploads/2023/05/Lipton-Ice-Tea-Peche-33cl-500-250.png", badge:null, options:[{ label: "Choix", type: "select", required: true, choices: ["Coca-Cola","Coca-Cola Zero","Fanta Orange","Sprite"] }] },
    { id:"bouteille", category:"boissons", name:"Bouteille 1.5L", description:"Grande bouteille 1.5L", price:3.50, image:"https://thumbs.dreamstime.com/b/bouteilles-de-boissons-non-alcoolis%C3%A9es-globales-assorties-93282763.jpg", badge:null, options:[{ label: "Choix", type: "select", required: true, choices: ["Coca-Cola","Coca-Cola Zero","Fanta Orange","Sprite","Eau"] }] }
